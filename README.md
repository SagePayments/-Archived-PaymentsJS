![SageLogoGreen](https://raw.githubusercontent.com/SagePayments/PaymentsJS/master/Samples/dotnet/shared/img/logo_sage_product.png)
#PaymentsJS
...
Samples in specific server-side languages are available in their respective repositories, including this one.
...
requirejs.config({
    paths: {
        "PayJS": 'https://dev.sagepayments.net/pay/js/build'
    },
});
```
